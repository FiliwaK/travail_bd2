...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=bd-tinfo;Initial Catalog=Bd_Reseau;Integrated Security=True;Encrypt=False").LogTo(Console.Write, LogLevel.Information);
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCompagnie).HasName("PK__tbl_comp__517CB383526E3185");
        });

        modelBuilder.Entity<TblEmployee>(entity =>
        {
            entity.HasKey(e => e.IdEmployee).HasName("PK__tbl_empl__F807679C1EBEBD5C");
        });

        modelBuilder.Entity<TblImpute>(entity =>
        {
            entity.HasKey(e => e.IdImpute).HasName("PK__tbl_impu__AD6F00C0AE557B07");
        ...
        {
            entity.HasKey(e => e.IdPiece).HasName("PK__tbl_piec__D20D1E0AD0287522");
        });

        modelBuilder.Entity<TblProjet>(entity =>
        {
            entity.HasKey(e => e.IdProjet).HasName("PK__tbl_proj__36C5661DB8280805");
        ...
        {
            entity.HasKey(e => e.IdStock).HasName("PK__tbl_stoc__3A39590ACFBF5FF4");
