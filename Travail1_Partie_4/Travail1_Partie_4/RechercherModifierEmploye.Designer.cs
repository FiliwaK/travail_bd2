namespace Travail1_Partie_4
{
    partial class RechercherModifierEmploye
    {
        ...
        private void InitializeComponent()
        {
            ...
            no_employe_TextBox = new TextBox();
            label4 = new Label();
            label5 = new Label();
            label6 = new Label();
            label7 = new Label();
            ...
            Modifier.Controls.Add(no_employe_TextBox);
            ...
            // no_employe_TextBox
            // 
            no_employe_TextBox.Location = new Point(110, 29);
            no_employe_TextBox.Name = "no_employe_TextBox";
            no_employe_TextBox.Size = new Size(600, 23);
            no_employe_TextBox.TabIndex = 7;
            // 
            // label4
            // 
        ...
        private TextBox no_employe_TextBox;
